...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in language_id_pb2_grpc.py depends on'
...
def add_LanguageIdServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zemberek.langid.LanguageIdService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class LanguageIdService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Detect(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/zemberek.langid.LanguageIdService/Detect',
            language__id__pb2.LanguageIdRequest.SerializeToString,
            language__id__pb2.LanguageIdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
