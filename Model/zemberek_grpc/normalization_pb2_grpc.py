...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in normalization_pb2_grpc.py depends on'
...
def add_NormalizationServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zemberek.normalization.NormalizationService', rpc_method_handlers)
...
class NormalizationService(object):
    ...
    def Normalize(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/zemberek.normalization.NormalizationService/Normalize',
            normalization__pb2.NormalizationRequest.SerializeToString,
            normalization__pb2.NormalizationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
